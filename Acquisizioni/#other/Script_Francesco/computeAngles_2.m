...
switch Exelobj.Segment
    ...
    case 'Thorax'
        ...
        Angles.Thorax.Sagittal.Acos =real(...
            acosd( round((Exelobj.ImuData.AccZ.*2/2^15), 1)))'-90;%AccZ e -90 tolti;
        ...
        Angles.Thorax.Frontal.Acos =real(...
            acosd( round(-Exelobj.ImuData.AccX.*2/2^15, 1)))'-90;%-AccX -90;
    ...
    case 'Homer'
        ...
        Angles.Homer.Frontal.Acos=real(...
            acosd( round(-Exelobj.ImuData.AccZ.*2/2^15,1)))'-90; %-AccZ -90
